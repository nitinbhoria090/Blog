...
const CommentBox = ({ selectedBlog }) => {
    ...
    const commentHandler = async () => {
        try {
            const res = await axios.post(`https://blog-2-zfmp.onrender.com/api/v1/api/v1/comment/${selectedBlog._id}/create`, { content }, {
                headers: {
    ...
    const editCommentHandler = async (commentId) => {
        try {
            const res = await axios.put(
                `https://blog-2-zfmp.onrender.com/api/v1/api/v1/comment/${commentId}/edit`,
    ...
    const deleteComment = async (commentId) => {
        try {
            const res = await axios.delete(`https://blog-2-zfmp.onrender.com/api/v1/api/v1/comment/${commentId}/delete`, {
                withCredentials: true
            })
            if (res.data.success) {
    ...
    const likeCommentHandler = async (commentId) => {
        try {
            const res = await axios.post(
                `https://blog-2-zfmp.onrender.com/api/v1/api/v1/comment/${commentId}/like`,
                {}, // empty body
                {
                    withCredentials: true
                }
    ...
    useEffect(() => {
        const getAllcommentOfBlog = async () => {
            try {
                const res = await axios.get(`https://blog-2-zfmp.onrender.com/api/v1/api/v1/comment/${selectedBlog._id}/comments`)
