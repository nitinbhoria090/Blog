...
const UpdateBlog = () => {
 ...
 const togglePublshUnpublish = async (action)=>{
  try {
    const res = await axios.patch(`https://blog-2-zfmp.onrender.com/api/v1/api/v1/blog/${id}`,{
      params:{
        action
      },
      withCredentials:true
 ...
 const deleteBlog = async ()=>{
  try {
    const res = await axios.delete(`https://blog-2-zfmp.onrender.com/api/v1/api/v1/user/blog/delete/${id}`,{withCredentials:true})
    if(res.data.success){
